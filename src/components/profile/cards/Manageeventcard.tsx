      ...
      <View style={styles.actions}>
        {event.status === 'live' && (
          <TouchableOpacity style={[styles.btn, styles.btnPrimary]} onPress={onCheckin}>
            <Ionicons name="qr-code-outline" size={12} color={Colors.bg} style={styles.btnIcon} />
        ...
        {event.status === 'upcoming' && (
          <TouchableOpacity style={[styles.btn, styles.btnPrimary]} onPress={onSendLink}>
            <Ionicons name="link-outline" size={12} color={Colors.bg} style={styles.btnIcon} />
            <Text style={styles.btnPrimaryText}>Enviar link</Text>
          </TouchableOpacity>
        )}
        {event.status === 'draft' && (
          <TouchableOpacity style={[styles.btn, styles.btnPrimary]} onPress={onPublish}>
            <Ionicons name="rocket-outline" size={12} color={Colors.bg} style={styles.btnIcon} />
...
const styles = StyleSheet.create({
  ...
  sub: { fontSize: 11.5, color: Colors.text2 },
  statsRow: {
    flexDirection: 'row',
    borderTopWidth: 1,
