...
const BADGE_CFG: Record<BadgeType, { label: string; bg: string; text: string; border: string }> = {
  ...
  out:      { label: 'Agotado',   bg: Colors.surface3, text: Colors.textSecondary, border: Colors.border },
...
const abt = StyleSheet.create({
  ...
  iconDisabled: { backgroundColor: Colors.surface3 },
  pill: {
    flexDirection: 'row', alignItems: 'center', gap: 5,
    backgroundColor: Colors.primary, borderRadius: 20,
    paddingHorizontal: 14, paddingVertical: 8,
  },
  pillDisabled: { backgroundColor: Colors.surface3 },
  pillText: {
